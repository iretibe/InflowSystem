...
namespace InflowSystem.Shared.Infrastructure.Contexts
{
    public class Context : IContext
    {
        ...
        public Context(HttpContext context) : this(context.TryGetCorrelationId(), 
            context.TraceIdentifier, new IdentityContext(context.User), 
