...
namespace InflowSystem.Shared.Infrastructure.Contracts
{
    internal sealed class ContractRegistry : IContractRegistry
    {
        ...
        private void ValidateContract(Type requestType, string path)
        {
            ...
            {
                var localProperty = GetProperty(contract.Type, propertyName, contractName, 
                    module, contractModule, path);

                var originalProperty = GetProperty(originalContractType, propertyName, contractName, 
                    module, contractModule, path);
        ...
        private static PropertyInfo GetProperty(Type type, string name, string contractName, 
            string module, string localModule, string path = null)
        {
        ...
        private void ValidateContract(Type contractType)
        {
