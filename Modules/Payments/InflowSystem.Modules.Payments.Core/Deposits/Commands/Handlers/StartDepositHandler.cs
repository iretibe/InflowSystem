...
namespace InflowSystem.Modules.Payments.Core.Deposits.Commands.Handlers
{
    internal sealed class StartDepositHandler : ICommandHandler<StartDeposit>
    {
        ...
        public StartDepositHandler(ICustomerRepository customerRepository, 
            IDepositRepository depositRepository, IDepositAccountRepository depositAccountRepository, 
            IClock clock, IMessageBroker messageBroker, ILogger<StartDepositHandler> logger)
        {
